...
export const config = {
	...
	render: {
		...
		// Сколько вкладок браузера рендерят кадры одновременно. Каждая
		// держит свою копию видео в памяти, зато кадры идут параллельно —
		// на многоядерном сервере это разница между двумя минутами и получасом.
		concurrencyPerRender: Number(opt('RENDER_CONCURRENCY_PER_JOB', 4)),
